...
public class ConsultaService {
     ...
     * Employee creates a new consultation slot with specialty, doctor, date/time, price, and slots
     */
     ...
     * Returns consultations with DISPONIVEL status, future date, and available slots
     */
     ...
     * Patient books a consultation slot, uses points for discount, receives unique booking code
     */
